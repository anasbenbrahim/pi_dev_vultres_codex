 ...
 */
final class Version20250304060932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chat_ai (id INT AUTO_INCREMENT NOT NULL, question VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE client (id INT NOT NULL, address VARCHAR(255) DEFAULT NULL, is_banned TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE demande (id INT AUTO_INCREMENT NOT NULL, offer_id INT DEFAULT NULL, service VARCHAR(255) NOT NULL, date_demande DATE DEFAULT NULL, cv_file_name VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', phone_number VARCHAR(20) NOT NULL, INDEX IDX_2694D7A553C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, equipement_id INT NOT NULL, fermier_id INT NOT NULL, fournisseur_id INT NOT NULL, proposition VARCHAR(255) NOT NULL, quantite INT NOT NULL, INDEX IDX_8B27C52B806F0F5C (equipement_id), INDEX IDX_8B27C52BB8CB1F8 (fermier_id), INDEX IDX_8B27C52B670C757F (fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fermier (id INT NOT NULL, farm_name VARCHAR(255) DEFAULT NULL, is_banned TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fournisseur (id INT NOT NULL, company_name VARCHAR(255) DEFAULT NULL, is_banned TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, publication_id INT NOT NULL, client_id INT NOT NULL, commentaire_id INT DEFAULT NULL, message VARCHAR(255) NOT NULL, date DATETIME DEFAULT NULL, reading TINYINT(1) NOT NULL, INDEX IDX_BF5476CA38B217A7 (publication_id), INDEX IDX_BF5476CA19EB6921 (client_id), INDEX IDX_BF5476CABA9CD190 (commentaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, domain VARCHAR(255) NOT NULL, date_offer DATE NOT NULL, description LONGTEXT NOT NULL, nb_places INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_AF3C677919EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reponse_devis (id INT AUTO_INCREMENT NOT NULL, devis_id INT NOT NULL, fournisseur_id INT NOT NULL, fermier_id INT NOT NULL, reponse VARCHAR(255) NOT NULL, etat TINYINT(1) NOT NULL, prix DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_64CEBE4841DEFADA (devis_id), INDEX IDX_64CEBE48670C757F (fournisseur_id), INDEX IDX_64CEBE48B8CB1F8 (fermier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT FK_8B27C52B806F0F5C FOREIGN KEY (equipement_id) REFERENCES equipements (id)');
        ...
        $this->addSql('ALTER TABLE reponse_devis ADD CONSTRAINT FK_64CEBE4841DEFADA FOREIGN KEY (devis_id) REFERENCES devis (id)');
        $this->addSql('ALTER TABLE reponse_devis ADD CONSTRAINT FK_64CEBE48670C757F FOREIGN KEY (fournisseur_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE reponse_devis ADD CONSTRAINT FK_64CEBE48B8CB1F8 FOREIGN KEY (fermier_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis DROP FOREIGN KEY FK_8B27C52B806F0F5C');
        ...
        $this->addSql('ALTER TABLE reponse_devis DROP FOREIGN KEY FK_64CEBE4841DEFADA');
        $this->addSql('ALTER TABLE reponse_devis DROP FOREIGN KEY FK_64CEBE48670C757F');
        $this->addSql('ALTER TABLE reponse_devis DROP FOREIGN KEY FK_64CEBE48B8CB1F8');

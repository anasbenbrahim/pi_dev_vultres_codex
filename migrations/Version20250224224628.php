 ...
 */
final class Version20250224224628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD cv_file_name VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, DROP cv');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer_employee (offer_id INT NOT NULL, employee_id INT NOT NULL, INDEX IDX_24E2C5C38C03F15C (employee_id), INDEX IDX_24E2C5C353C674EE (offer_id), PRIMARY KEY(offer_id, employee_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE demande ADD cv VARCHAR(255) NOT NULL, DROP cv_file_name, DROP updated_at');

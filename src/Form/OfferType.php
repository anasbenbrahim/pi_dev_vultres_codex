...
use Symfony\Component\Form\Extension\Core\Type\IntegerType; // Added for proper number fields
...
class OfferType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('nbPlaces', IntegerType::class, [  // Changed to IntegerType for nbPlaces
